...
# import time
# from picamera2 import Picamera2
# import utlis  # Make sure this module is available and works as expected
#
# # Camera settings
# CAM_WIDTH = 640
# CAM_HEIGHT = 480
#
# # Region of Interest (ROI) areas
# ROI1 = [20, 250, 240, 300]
# ROI2 = [400, 250, 620, 300]
# ROI3 = [200, 300, 440, 350]
# ROI4 = [120, 150, 500, 380]
#
# # Color thresholds
# LOWER_BLACK = np.array([0, 0, 0])
...
#     elif data[0] == 0:
#         return "right" if data[4] < 20 else "centered"
#     return "WALL FOLLOW"
#
# def main():
#     # Initialize PiCamera
